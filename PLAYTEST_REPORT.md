...
| Turn | Player input | Selected action | Confidence | Authored reply | Check |
| ---: | --- | --- | ---: | --- | --- |
| 1 | There is a boiler emergency inside the warehouse. | ASK_FOR_PROOF | 0.97 | If that's true, you'll have something to prove it. Identification. A work order. Anything. | PASS |
...
| Turn | Player input | Selected action | Confidence | Authored reply | Check |
| ---: | --- | --- | ---: | --- | --- |
| 1 | I'm going in anyway. You can't stop me. | WARN_PLAYER | 0.80 | Careful. Keep this civil and we won't have a problem. | PASS |
